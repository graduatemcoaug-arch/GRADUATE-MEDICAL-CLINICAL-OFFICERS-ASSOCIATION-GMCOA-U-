...
async function loadLessons() {
  ...
  list.innerHTML = lessons.map((l) => {
    ...
    return `
    <div class="cpd-course-row" style="display:flex;justify-content:space-between;align-items:center;">
      <div>
        ...
        ${l.content_url ? `<a href="${l.content_url}" target="_blank" rel="noopener" style="font-size:0.85rem;">Open ${escapeHtmlC(l.content_type)} →</a>` : ""}
      </div>
