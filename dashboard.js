document.addEventListener("DOMContentLoaded", () => {
  ...
  document.getElementById("show-announcements-btn").addEventListener("click", () => {
    document.getElementById("announcements-list").style.display = "block";
    document.getElementById("show-announcements-btn").style.display = "none";
  });
});
...
async function loadAnnouncements() {
  ...
  if (!data || data.length === 0) {
    ...
    document.getElementById("show-announcements-btn").textContent = "View Announcements (0)";
    return;
  }

  document.getElementById("show-announcements-btn").textContent = `+ View Announcements (${data.length})`;
