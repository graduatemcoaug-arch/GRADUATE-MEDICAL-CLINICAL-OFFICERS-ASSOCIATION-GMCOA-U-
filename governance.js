...
async function checkSession() {
  ...
  if (session) enforceRole(["Governance","Education Committee","Other Committee","Secretariat"], showDashboard);
}
...
async function login(e) {
  ...
  enforceRole(["Governance","Education Committee","Other Committee","Secretariat"], showDashboard);
}
